...
//
//    // 총평 후기 작성
//    public boolean writeTotal(String member, String musicalId, String scoreStory, String scoreDirect, String scoreCast, String scoreNumber, String reviewMuTxt){
//        ReviewTotal reviewTotal = new ReviewTotal();
//        reviewTotal.setMember(member);
//        reviewTotal.setMusicalId(musicalId);
...
////        reviewTotal.setScoreAvgTotal(scoreAvgTotal);
